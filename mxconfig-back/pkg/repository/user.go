...
func (r *UserMongoDB) FindAll(collectionName string, filter bson.D, result interface{}) (interface{}, error) {
...
//	}
func (r *UserMongoDB) FindOne(collectionName string, filter bson.D, result interface{}) (interface{}, error) {
	return utils.FindOne(r.db, collectionName, filter, result)
}
